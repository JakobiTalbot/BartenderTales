...
public struct PageSide
{
    ...
    public TextMeshProUGUI m_potionNameText;
}
...
public class Page : MonoBehaviour
{
    ...
    /// <param name="potionName"> The name of the potion to be printed on the recipe book </param>
    /// <param name="sideIndex"> Which side of the page to display recipe on (0/1) </param>
    public void SetImages(Texture ingredient1, Texture ingredient2, Texture potion, string potionName, int sideIndex)
    {
        ...
        m_recipePageSides[index].m_potionNameText.text = potionName;
    }
}
